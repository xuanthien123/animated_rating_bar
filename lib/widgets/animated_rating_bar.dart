...
class AnimatedRatingBar extends StatefulWidget {
  ...
  const AnimatedRatingBar(
      ...
      this.animationColor}): super(key: key);
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: RiveAnimation.asset(
        "packages/animated_rating_bar_2/assets/new_rating_animation.riv",
        onInit: (artboard) {
              ...
              if (child is Shape) {
                ...
                if (widget.activeFillColor != null) {
                  if (shape.name == "Star_1" ||
                      ...
                      shape.name == "Star_4" ||
                      shape.name == "Star_5") {
                    (shape.fills.first.children[0] as SolidColor).colorValue = widget.activeFillColor!.value;
                  } else if (shape.name == "Star_base_1" ||
                      shape.name == "Star_base_2" ||
                      shape.name == "Star_base_3" ||
                      shape.name == "Star_base_4" ||
                      shape.name == "Star_base_5") {
                    (shape.strokes.first.children[0] as SolidColor).colorValue = widget.strokeColor?.value ?? widget.activeFillColor!.value;
                  } else if (shape.name == "Star_4_glow" || shape.name == "Star_5_glow" || shape.name == "Star_5_sparks") {
                    (shape.strokes.first.children[0] as SolidColor).colorValue = widget.animationColor?.value ?? widget.activeFillColor!.value;
                  }
                } else {
                  ...
                  if (shape.name == "Star_1" ||
                    ...
                    (shape.fills.first.children[0] as SolidColor).colorValue =
                        isDarkMode ? ThemeData.light().primaryColor.value : ThemeData.dark().primaryColor.value;
                  } else if (shape.name == "Star_4_glow" || shape.name == "Star_5_glow" || shape.name == "Star_5_sparks") {
